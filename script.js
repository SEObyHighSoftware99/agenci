...
/* =========================================================
   AlgorithmOptix IT ULTRA PREMIUM BUTTON RIPPLE SYSTEM
   Applies ripple to most buttons across all pages
========================================================= */
document.addEventListener("DOMContentLoaded", function () {
  const AlgorithmOptix ITButtons = document.querySelectorAll(`
    button,
    .btn,
    .btn-primary,
    .btn-secondary,
  ...
  AlgorithmOptix ITButtons.forEach((btn) => {
    // Hover ripple from center
    btn.addEventListener("mouseenter", function () {
      const rect = btn.getBoundingClientRect();
      createAlgorithmOptix ITButtonRipple(btn, rect.width / 2, rect.height / 2);
    });
    ...
    btn.addEventListener("click", function (e) {
      ...
      createAlgorithmOptix ITButtonRipple(btn, x, y);
    });
  });

  function createAlgorithmOptix ITButtonRipple(btn, x, y) {
    const ripple = document.createElement("span");
    ripple.className = "AlgorithmOptix IT-btn-ripple";
...
/* =========================
   AlgorithmOptix IT WAVE LOADER HIDE
========================= */
...
/* =========================
   AlgorithmOptix IT CUSTOM CURSOR RING
========================= */
